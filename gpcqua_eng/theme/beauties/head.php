...
<div id="logo_dna">
    <div class="wrap">
        <a href="<? Echo G5_URL ?>" class="logo s_mobile_no"><img src="<?php echo G5_THEME_URL ?>/img/GPC_ci.png" alt="GPC Global Personnel Certification"></a>
        <div id="telnum" class="s_mobile_none">
            <p>
                <span class="material-icons" style="color:#8f84c9;">ring_volume</span>&nbsp;
                <a href="tel:+82 2 6749-0710" title="Contact Us" style="letter-spacing: -.7px">T&nbsp;&nbsp;&nbsp;E&nbsp;&nbsp;&nbsp;L :&nbsp; +82 &nbsp;2&nbsp; 6749&nbsp; 0710</a>
            </p>
            <p>
                <span class="material-icons" style="color:#8f84c9;">forward_to_inbox</span>&nbsp;
                <a href="mailto: info@gicert.org" title="Send Email" style="letter-spacing: .1px" class="gpc_email">E-mail : info@gpcert.org</a>
            </p>
        </div>
    </div>
</div>
...
<!--		</div>-->
		...
		<nav class="user pc_only">
		    <a href="javascript:" class="user_menu" title="User menu"><span class="material-icons">person</span></a>
			<ul>
				<?php if ($is_member) {  ?>
		...
		<div class="util pc_only">
		    <a href="/" class="eng" title="한국어사이트/To Korea"><strong class="e_btn"><span class="material-icons">language</span>KOR</strong></a><!--title="ENGLISH"-->
		    <a href="javascript:" class="search" title="Search">
		        <span class="material-icons">search</span><strong class="btn_search">Search</strong>
            </a>
            <a href="https://igc.gpcacademy.org/?lang=ko" class="btn_igc_academy" title="IGC ACADEMY" target="_blank">
                <strong class="igc_a_btn"><img src="/theme/gpcert/img/IGC_ACADEMY_LOGO.png" alt="IGC ACADEMY"></strong>
            </a>
            <!--유틸메뉴 IGC 아카데미추가 210714 전산팀 yr-->
		</div>
        ...
        <div class="m_util_wrap">
            <h1 class="m_logo"><a href="/" class="s_mobile_only"></a></h1>
            <a href="<?php echo G5_BBS_URL ?>/login.php" class="btn_user mobile_only" title="Login"><span class="material-icons">person</span></a> 
            <a href="javascript:" class="btn_search mobile_only" title="Search"><span class="material-icons">search</span></a>
            <a href="javascript:" class="btn_gnb mobile_only" title="Menu"><i class="fa fa-bars" aria-hidden="true"></i></a>
            <a href="/" class="btn_eng mobile_only" title="한국어사이트/To Korea"><strong class="e_btn"><span class="material-icons">language</span>KOR</strong></a>
...
-->
    ...
    <div class="header_btm_border"></div> <!--header 하단에 border 생성 211222 전산팀 yr-->
...
$(function(){
	...
	if(!isMobile){
		...
		$("#header .depth1").on("mouseover", function(){
            ...
            $(".header_btm_border").stop().addClass('down'); /* header depth1에 마우스오버시 header_btm_border.down 클래스 추가  211223 전산팀 yr */
            $(".header_btm_border").stop().addClass('down_stay'); /* header depth1에 마우스오버시 header_btm_borderdown_stay 클래스 추가  211223 전산팀 yr */
		});
        /* header depth1에 마우스리브시 header gnb.down 클래스 제거 */
		$("#header").on("mouseleave", function(){
			$("#header").stop().removeClass('down');
            $(".header_btm_border").stop().removeClass('down'); /* header depth1에 마우스리브시 header_btm_border.down 클래스 제거  211223 전산팀 yr */
            $(".header_btm_border").stop().addClass('up'); /* header depth1에 마우스리브시 header_btm_border.up 클래스 추가 211223 전산팀 yr */
            $(".header_btm_border").stop().removeClass('down_stay'); /* header depth1에 마우스리브시 header_btm_borderdown_stay 클래스 제거   211223 전산팀 yr */
		});
        
         /* 유틸리티 회원메뉴 클릭시 header gnb.down 추가 20210608 책임자: 이혜정 */
        $("#header .user .user_menu").on("click", function(){
            $("#header").toggleClass('down');
            $(".header_btm_border").toggleClass('down'); /* header depth1에 마우스오버시 header_btm_border.down 클래스 추가  211223 전산팀 yr */
            $(".header_btm_border").toggleClass('down_stay'); /* header depth1에 마우스오버시 header_btm_borderdown_stay 클래스 추가  211223 전산팀 yr */
        });
...
$str = explode("/",$_SERVER["REQUEST_URI"]); 
	switch($str[4]){ // url 3번째 폴더명 기준으로 navigation경로 수동 지정
		case "service" : $pageName="Services"; $depth1="> Services"; $depth1_link="/gpcqua_eng/theme/gpcert/service/auditor_scheme.php"; break;
	} 
?> 
<div id="sub_visual" class="sub100">
    <div class="bg"></div>
	<h2>
		<? 
			if($pageName != "") {
...
<div id="sub_navi">
	<div class="wrap">
		<ul>
			<li><a href="/"><i class="fa fa-home" aria-hidden="true"></i> HOME</a></li>
			<li><a href="<?php echo $depth1_link?>"><?php echo $depth1?></a></li>
