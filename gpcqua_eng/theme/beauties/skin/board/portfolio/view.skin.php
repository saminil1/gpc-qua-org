    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		<span class="sound_only">작성자</span> <strong><?php echo $view['name'] ?><span class="mobile_no"><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></span></strong><br>
       		 	<span class="sound_only">댓글</span><strong><a href="#bo_vc"> <i class="fa fa-comments" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?>건</a></strong>
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기"><i class="fa fa-pencil-alt" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li><?php } ?>
