        ...
        <ul class="btn_bo_user">
        	...
        	<li>
		        ...
		        <ul class="more_opt is_list_btn">  
		            <li><button type="submit" name="btn_submit" value="Sel-del" onclick="document.pressed=this.value"><i class="fa fa-trash" aria-hidden="true"></i> Sel-del</button></li>
		            ...
		            <li><button type="submit" name="btn_submit" value="Sel-move" onclick="document.pressed=this.value"><i class="fa fa-arrows-alt" aria-hidden="true"></i> Sel-move</button></li>
		        </ul>
		        <?php } ?>
        	</li>
        	<?php }  ?>
