    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		<span class="sound_only">Name</span> <strong><?php echo $view['name'] ?><span class="mobile_no"><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></span></strong><br>
       		 	<span class="sound_only">Comment</span><strong><a href="#bo_vc"> <i class="fa fa-comments" aria-hidden="true" style="color:#888"></i> <?php echo number_format($view['wr_comment']) ?></a></strong>
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="Write"><i class="fas fa-pencil-alt" aria-hidden="true"></i><span class="sound_only">Write</span></a></li><?php } ?>
	        	...
	        	<li>
		        	...
		        	<ul class="more_opt is_view_btn"> 
			            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>">Edit<i class="fas fa-pencil-alt" aria-hidden="true"></i></a></li><?php } ?>
			            <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;">Del<i class="fa fa-trash" aria-hidden="true"></i></a></li><?php } ?>
			            ...
			            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;">Move<i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li><?php } ?>
