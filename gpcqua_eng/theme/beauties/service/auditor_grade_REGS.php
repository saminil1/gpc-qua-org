...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			...
			<li class="on"><a href="/gpc_eng/theme/gpcert/service/auditor_grade_REGS.php">Grade/Registration requirements</a></li>
            ...
            <li><a href="/gpc_eng/theme/gpcert/service/auditor_FAQ.php">FAQ</a></li>
		</ul>
	</div>
                ...
                <ul>
                    <li>
                        <dl>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="5" style="vertical-align: middle;">
                                                <ul>
                                                    <li>1) Education level beyond secondary graduation</li><br>
                                                    <li>2) Pass the GPC knowledge and attribution examination</li><br>
                                                    <li>
                                                        3) Completion of ISO Auditor/Lead Auditor training Course<br>
                                                        - Within 3 years, only a certificate of completion from an accredited personnel certification body or a training organization designated by it can be accepted
                                                    </li>
                                                </ul>
                                            </td>
                                            ...
                                            <td class="none">
												<ul>
													<li>
														...
														<p>- Over 5 years of work experience (including at least 2 years of experience related to the application standards)</p>
													</li><br>
													<li>
														<p>2) Audit log of at least 20M/D within 3 years*</p>
														<p>*When applying through on-site competence evaluation method: Verification audit records from companies that have established the applied standard management system</p>
													</li>
												</ul>
											</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="none">
												<ul>
													...
													<li>
														<p>2) Audit log of at least 35M/D within 3 years (Including at least 15 M/D as a Lead Auditor)</p>
													</li>
												</ul>
											</td>
                                        </tr>
                                        <tr>
											...
											<td class="none">
												<ul>
													<li>
														<p>1) Work experience</p>
														<p>- Over 10 years of work experience (including at least 5 years of experience related to the application standards)</p>
													</li><br>
													<li>
														<p>2) Audit log of at least 15M/D within 3 years as a lead auditor (only audit log after obtaining a Lead Auditor certification from an accredited personnel certification body)</p>
													</li><br>
													<li>
														<p>3) Application is eligible 1 year after the registration date for the certified lead auditor qualification from an accredited personal certification body</p>
													</li>
												</ul>
											</td>
										</tr>
                                        <tr>
											...
											<td class="none">
												<ul>
													<li>
														<p>1) Work experience</p>
														<p>- Over 3 years of work experience (including at least 1 year of experience related to the application standards)</p>
													</li><br>
													<li>
														<p>2) Audit log of at least 15M/D within 3 years as a internal auditor (at least 5 audits)</p>
													</li>
												</ul>
											</td>
										</tr>
                            ...
                            <dd style="margin:0 0 70px">
                                <h3 class="con_stt point_col">
                                    <i class="fas fa-check-circle" style="margin-right:10px"></i>Transition
                                </h3>
                                <table class="type03">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="85%">
                                                <p>Submission of Valid Auditor Certificate as of the application date.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="type02">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="3">
                                                <li>
													<p>1) Audit log of as least 10M/D within 3 years as of expiration date</p>
												</li><br>
												<li>
													<p>2) Over 16 hours of CPD(Continuing Professional Development) record within 3 years as of expiration date</p>
												</li>
                                            </td>
                                            <td class="none">
                                                <p>-</p>
                                        ...
                                        <tr>
                                            ...
                                            <td class="none">
                                                <p>Including audit log as a lead auditor at least once</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>
                                            ...
                                            <td class="none">
                                                <p>Including audit log as a lead auditor at least once and on-site competence evaluation activity</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <span style="display:block;font-size:0.85rem">*For all grades, recertification applications must be made every 3 years from the date of initial issue.</span>
                                <span style="display:block;font-size:0.85rem">*In case of recertification of Provisional auditor, please recomplete the application form and submit it.</span>
                            </dd>
                        </dl>			
                    </li>
                </ul>
