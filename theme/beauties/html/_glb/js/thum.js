...
$(function () {
  ...
  function updateResults (img, data) {
    ...
    if (!(img.src || img instanceof HTMLCanvasElement)) {
	  ...
	  $('div.picture').find('input[name=install_pic]').val('');
    } else {

	  var img_url = img.toDataURL();
	  $('div.picture').css('background-image','url('+img_url+')');
	  $('div.picture').find('span').hide();
	  $('div.picture').find('span').hide();
	  $('div.picture').find('input[name=install_pic]').val(1);
