...
$g5['title'] = 'PHP배열함수';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조------->
...
<style>
	...
	@media screen and (max-width:992px){
		...
		.business_type2 .business_info ul li.left_box { width:100%; height:auto;  }
...
<div class="content_wrap">
	...
	<hr style="border-top: 5px solid #ff9900;;display:inline-block;margin-bottom:0px;margin-top:50px;width:100%;color:">
        <h1>PHP 배열 선언 방법3 : array함수 사용하는 방법</h1>
        <?php
        // $week = explode(",","가,나,다,라,마,바,사);
        // print $week[3];

        $moonth = array("1번째","2번째","3번째","4번째","5번째","6번째","7번째","8번째","9번째","10번째","11번째","12번째");
        $nation = array(
            "1번) 대한민국",
            "2번) 미국",
            "3번) 일본",
