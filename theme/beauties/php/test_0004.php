...
$g5['title'] = '배열 출력';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조------->
...
<div class="content_wrap">
   ...
   <h1>여기서부터는 내용들어가는 영역입니다.</h1>
        <?php 
        $array = array('가','나','다','라','마','마','사','아','자','차','타','파','하');
        ?>
        <?php
        echo "<table border='1'><tr><td><td><td><td>";
        print_r($array);
