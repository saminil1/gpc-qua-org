...
$g5['title'] = '다중배열 출력 02';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조------->
...
?>
    ...
    <div class="content_wrap">
        <section class="page_title">
            ...
            <h1>여기서부터는 배열출력 02 내용들어가는 영역입니다.</h1>
            <?php
            $array = array("가","나","다","라","마","바","사","아","자","카","타","파","하");
            $array[나] = array('a1','b1', 'c1','d1','e1','f1','g1');
            $array[가] = array('b1','b2','b3','b4','b5');
            $array[하] = array('c1','c2','c3','c4','c5','c6');

            echo "<pre><table border='1' <tr><td>"; print_r($array); echo "</td></tr></table></pre>";
            ?>
            
            <?php
            echo "<br>배열변수만 대입해서 결과 확인함\n";
            echo "<pre> 01.POST출력 : "; print_r($_POST); echo "</pre>";
            print "<pre>02.GET출력 : "; print_r($_GET); print "</pre>";
            print "<pre>03.SERVER출력 : "; print_r($_SERVER); print "</pre>";
            ?>
