    ...
    <div class="content_wrap">
        <section class="page_title">
            ...
            <?php
                ...
                if(!is_null($username)){
                    $jb_conn = mysqli_connect("localhost","gicertorg1","ikongboo26341@","gicertorg1","3306");
                    $jb_sql = "SELECT username FROM member1 WHERE username = '$username';";
                    ...
                    if($username == $username_e){
                        ...
                        $jb_sql_add_user = "INSERT INTO member1 (username, password) VALUES ('$username','$encrypted_password');";//VALUES 값에 쌍따옴표는 에러발생함
            ...
            ?>
                ...
                <style>
                    input,button,{
                        font-family:inherit;font-sㅃize:inherit;
                    }
                </style>
                ...
                <form action="register.php" method="POST">
                   <p>아이디입 : <input type="text" name="username" placeholder="아이디입력해주세요." required></p>
                   <p>비밀번호 : <input type="password" name="password" placeholder="비밀번호를 입력해주세요." required></p>
                   <p>비밀번호 : <input type="password" name="password_confirm" placeholder="비밀번호 재입력해주세요." required></p>
                    <p><input type="submit" value="회원등록"></p>

                    <?php
                        if($wu ==1){
                            echo "<p>아이디가 중복되었습니다. 다른 아이디를 입력해주새ㅔ요.</p>";
                        }
                        if($wp == 1){
                            echo "<p>비밀번호가 일치하지 않습니다. 다른 비밀번호를 입력해주세요.</p>";
                        }
                    ?>
                </form>
