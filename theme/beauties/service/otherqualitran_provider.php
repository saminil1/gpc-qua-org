...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			<!-- 활성화 메뉴에 class="on" // 탭메뉴 페이지 분리 2024.01.25 By Mark. -->
			<li class="on"><a href="/theme/beauties/service/otherqualitran_provider.php">기타자격연수기관</a></li>
			<li><a href="/theme/beauties/service/otherqualitran_process.php">연수기관지정절차</a></li>
            <li><a href="/theme/beauties/service/otherqualitran_list.php">연수기관지정현황</a></li>
            <li><a href="/theme/beauties/service/otherqualitran_faq.php">FAQ</a></li>
		</ul>
	</div>
