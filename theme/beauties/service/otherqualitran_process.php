...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			...
			<li><a href="/theme/beauties/service/otherqualitran_provider.php">기타자격연수기관</a></li>
			<li class="on"><a href="/theme/beauties/service/otherqualitran_process.php">연수기관지정절차</a></li>
