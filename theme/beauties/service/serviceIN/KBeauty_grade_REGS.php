...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			...
			<li class="on"><a href="/theme/gpcert/service/KBeauty_grade_REGS.php"><span>K-beauty 자격 등급 및 요구사항</span></a></li>
    ...
    <div class="tab_con">
        ...
        <article style="display:block"><!--+++++ 컨텐츠 02 시작 +++++--> 
            <div class="page_title">
                <h1 class="top_tt point_col">K-beauty 자격 등급 및 요구사항</h1>
            </div>
            <div class="page_con">
            	<ul>
            		<li>
            			<dl>
            				<dt class="con_img">
                                ...
                                <img src="/data/editor/2311/thumb-07c6a7af532745b6d819327a7b704de0_1700467493_0417_600x401.jpg" alt="헤어 드라이어를 들고 여자">
                            </dt>
            				<dd>
