<?php
$page_meta_tags = '
<meta name="title" content="심사원 교육 진행절차">
...
<meta property="og:title" content="심사원 교육 진행절차">
...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			...
			<li class="on"><a href="/theme/gpcert/service/edu_process.php">교육 진행절차</a></li>
            <li><a href="/theme/gpcert/service/edu_FAQ.php">심사원교육 FAQ</a></li>
		</ul>
	</div>
    
    <div class="tab_con">
		<!--+++++ 교육 진행 절차 // 탭메뉴 페이지 분리 20230323 HJ +++++-->
                            ...
                            <dd class="con_txt" >
                                <div class="step_wrap">
                                    <div class="step">
                                        ...
                                        <p>온라인 교육 홈페이지에 회원 가입 및 수강을 원하는 교육 과정 신청</p>
                                    </div>
                                    <div class="step">
                                        <div class="arrow">
                                            <span class="triangle"></span>
                                        ...
                                        <p>발행된 인보이스 하단의 계좌정보 확인 후 교육 비용 납부</p>
                                    </div>
                                    <div class="step">
                                        <div class="arrow">
                                            <span class="triangle"></span>
                                ...
                                <div class="step_wrap">
                                    <div class="step">
                                        ...
                                        <div class="icon">
                                            <img src="./image/open-book.png" alt="교육 성취도 향상">
                                        </div>
                                        <h4 class="arrow_tit">4. 교육 성취도 향상</h4>
                                        <p>주어진 사례에서 부적합 사항을 찾아내는 케이스스터디 및 워크샵을 통해 ISO 경영시스템 요구사항에 대한 이해도 및 응용력 향상</p>
                                    </div>
                                    <div class="step">
                                        <div class="arrow">
                                            <span class="triangle"></span>
