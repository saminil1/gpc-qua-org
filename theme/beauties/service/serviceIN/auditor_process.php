<?php
$page_meta_tags = '
<meta name="title" content="심사원 인증 절차">
<meta name="description" content="심사원 인증 절차, 1. 신청 서류 접수, 2. 1차 서류 검토, 3. 비용 청구, 4. 서류 최종 검토, 5. 인증심의 및 승인, 6. 인증서 발행, 7. 원본 및 등록카드 발송">
<meta name="keywords" content="심사원 인증 절차, 심사원 인증 프로세스, 접수, 검토, 비용 청구, 최종 검토, 인증심의, 승인, 인증서 발행, 등록카드">
<meta property="og:type" content="website">
<meta property="og:title" content="심사원 인증 절차">
<meta property="og:description" content="심사원 인증 절차 1. 신청 서류 접수 2. 1차 서류 검토 3. 비용 청구 4. 서류 최종 검토 5. 인증심의 및 승인 6. 인증서 발행 7. 원본 및 등록카드 발송">
<meta property="og:url" content="https://www.gpcert.org/theme/gpcert/service/auditor_process.php">
';
...
<style>  
	...
	.con_txt .step_wrap:nth-child(3) .step {flex: 0.315}/* .step의 갯수가 홀수여서 사이즈 변경 */
...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			...
			<li><a href="/theme/gpcert/service/auditor_grade_REGS.php">심사원등급/요구사항</a></li>
			<li class="on"><a href="/theme/gpcert/service/auditor_process.php">심사원 인증절차</a></li>
    ...
    <div class="tab_con">
        <!--+++++ 심사원 인증 절차 // 탭메뉴 페이지 분리 20230322 HJ +++++-->
                            ...
                            <dd class="con_txt" >
                                <div class="step_wrap">
                                    ...
                                    <div class="step">
                                        ...
                                        <div class="icon">
                                            <img src="./image/document.png" alt="1차 서류 검토">
                                        </div>
                                        <h4 class="arrow_tit">2. 1차 서류 검토</h4>
                                        <p>제출된 신청서 및 자료들을 검토합니다.</p>
                                    </div>
                                    <div class="step">
                                        <div class="arrow">
                                            <span class="triangle"></span>
                                        ...
                                        <div class="icon">
                                            <img src="./image/invoice.png" alt="비용 청구">
                                        </div>
                                        <h4 class="arrow_tit">3. 비용 청구</h4>
                                        <p>인보이스를 통해 등록 비용이 청구됩니다.</p>
                                    </div>
                                </div>
                                <div class="step_wrap">
                                    <div class="step">
                                        ...
                                        <div class="icon">
                                            <img src="./image/paper.png" alt="서류 최종 검토">
                                        </div>
                                        <h4 class="arrow_tit">4. 서류 최종 검토</h4>
                                        <p>추가적인 증빙이 필요한 경우 자료 보완을 요청하며 제출된 서류들을 최종적으로 검토합니다.</p>
                                    </div>
                                    <div class="step">
                                        <div class="arrow">
                                            <span class="triangle"></span>
                                        ...
                                        <div class="icon">
                                            <img src="./image/compliant.png" alt="인증심의 및 승인">
                                        </div>
                                        <h4 class="arrow_tit">5. 인증심의 및 승인</h4>
                                    ...
                                    <div class="step">
                                        ...
                                        <p>인증결정위원회로부터 인증등록이 승인되면 인증서를 발행합니다.</p>
                                    </div>
                                </div>
                                <div class="step_wrap">
                                    <div class="step">
                                        <div class="arrow">
                                            <span class="triangle"></span>
                                            <span class="arrow_txt"><span style="display: inline-block;width: 20px"></span>Step 7</span>
                                        </div>
                                        <div class="icon">
                                            <img src="/data/editor/2306/40d45e9e3212e645aa100ca90dc48cb8_1687829751_0437.png" alt="원본 및 등록카드 발송">
                                        </div>
                                        <h4 class="arrow_tit">7. 원본 및 등록카드 발송</h4>
                                        <p>사전에 안내 받은 주소로 인증서 원본 및 등록카드를 발송합니다.</p>
                                    </div>
								</div>
                            </dd>
                        </dl>
