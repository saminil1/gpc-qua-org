...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			<!-- 처음 활성화 메뉴에 class="on" -->
			<li class="on"><a href="/theme/gpcert/service/KBeauty_introduction.php"><span>K-beauty 인증 소개</span></a></li>
			<li><a href="/theme/gpcert/service/KBeauty_grade_REGS.php"><span>K-beauty 자격 등급 및 요구사항</span></a></li>
			<li><a href="/theme/gpcert/service/KBeauty_process.php"><span>K-beauty 인증 절차</span></a></li>
    ...
    <div class="tab_con">
        ...
        <article style="display:block">
            <div class="page_title">
                <h1 class="top_tt point_col">K-beauty 인증 소개</h1>
            </div>
            <div class="page_con">
            	<ul>
            		<li>
            				...
            				<dd>
								...
								<ul class="con_sec imgFlex">
									<li>
										...
										<img src="/data/editor/2311/07c6a7af532745b6d819327a7b704de0_1700467493_2895.jpg" alt="K-Beauty Skincare (스킨케어)">
										<p>K-Beauty Skincare (스킨케어)</p>
									</li>
									<li>
										<!--<img src="./image/Semi-Permanent.png" alt="K-Beauty Semi-Permanent (반영구)">-->
										<img src="/data/editor/2311/07c6a7af532745b6d819327a7b704de0_1700467493_2246.jpg" alt="K-Beauty Semi-Permanent (반영구)">
										<p>K-Beauty Semi-Permanent (반영구)</p>
									</li>
									<li>
										<!--<img src="./image/SMP.png" alt="K-Beauty Scalp Micro Pigmentation (SMP)">-->
										<img src="/data/editor/2311/07c6a7af532745b6d819327a7b704de0_1700467493_4603.jpg" alt="K-Beauty Scalp Micro Pigmentation (SMP)">
										<p>K-Beauty Scalp Micro Pigmentation (SMP)</p>
									</li>
									<li>
										<!--<img src="./image/Eyelash Extension.png" alt="K-Beauty Eyelash Extension (속눈썹 연장)">-->
										<img src="/data/editor/2311/07c6a7af532745b6d819327a7b704de0_1700467492_3001.jpg" alt="K-Beauty Eyelash Extension (속눈썹 연장)">
