...
<!--
     서브페이지 배너 이미지 추가, 2024년2월5일 By Mark 
    <div id="subpage-banner">
        <img src="https://beautycet.mycafe24.com/theme/beauties/img/sub_visual_02.jpg" alt="Subpage Banner" style="width: 100%;">
    </div>
-->

	<div class="tab_menu tab01">
		<ul>
			<!-- 활성화 메뉴에 class="on" // 탭메뉴 페이지 분리 2024.01.1.25 By mark -->
			<li><a href="/theme/beauties/service/certificate_instroduction.php">beauty자격분야</a></li>
			<li class="on"><a href="/theme/beauties/service/certificate_graderequjire.php">등급/요구사항</a></li>
            <li><a href="/theme/beauties/service/certificate_registprocess.php">등록절차</a></li>
            <li><a href="/theme/beauties/service/certificate_fee.php">자격비용</a></li>
            <li><a href="/theme/beauties/service/certificate_faq.php">beauty자격FAQ</a></li>
		</ul>
	</div>
