...
<div class="content_wrap">
	<div class="tab_menu tab01">
		<ul>
			...
			<li class="on"><a href="/theme/beauties/service/otherquali_instroduction.php">기타자격분야</a></li>
			<li><a href="/theme/beauties/service/otherquali_require.php">요구사항</a></li>
            <li><a href="/theme/beauties/service/otherquali_process.php">등록 절차</a></li>
            <li class="on"><a href="/theme/beauties/service/otherquali_fee.php">자격 비용</a></li>
			<li><a href="/theme/beauties/service/otherquali_faq.php">FAQ</a></li>
		</ul>
	</div>
