        ...
        <ul class="btn_bo_user">
        	...
        	<li>
		        ...
		        <ul class="more_opt is_list_btn">  
		            ...
		            <li><button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value"><i class="fa fa-arrows-alt" aria-hidden="true"></i> 선택이동</button></li>
		        </ul>
		        <?php } ?>
        	</li>
        	<?php }  ?>
...
-->
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="mobile_no"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 </a></th>
