...
<fieldset id="sch_res_detail">
    ...
    <select name="sfl" id="sfl">
        <option value="wr_subject||wr_content"<?php echo get_selected($_GET['sfl'], "wr_subject||wr_content") ?>>Title+Content</option>
...
<div id="sch_result">
   ...
   <!-----?php //  내용관리 검색 기능 시작
    ...
    <section id="sch_res_ov">
        ...
        <ul>
            <li>게시판1 <?php echo $board_count ?>개1</li>
            <li>게시물1 <?php echo number_format($total_count) ?>개1</li>
