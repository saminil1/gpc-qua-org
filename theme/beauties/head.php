...
<div id="logo_dna">
    <div class="wrap">
        <a href="/" class="logo s_mobile_no"><img src="<?php echo G5_THEME_URL ?>/img/GPC_ci.png" alt="GPC 지피씨인증원"></a>
        <div id="telnum" class="s_mobile_none">
            <p>
                <span class="material-icons" style="color:#8f84c9;">ring_volume</span>&nbsp;
                <a href="tel:+82 2 6749-0710" title="전화상담 하기" style="letter-spacing: -.7px">전&nbsp;&nbsp;&nbsp;&nbsp;화 :&nbsp; +82 &nbsp;2&nbsp; 6749&nbsp; 0710</a>
            </p>
            <p>
                <span class="material-icons" style="color:#8f84c9;">forward_to_inbox</span>&nbsp;
                <a href="mailto: info@gicert.org" title="이메일 보내기" style="letter-spacing: .1px" class="gpc_email">이메일 : qua@gpcert.org</a>
            </p>
        </div>
    </div>
</div>
...
<!--		</div>-->
		...
		<nav class="user pc_only">
		    <a href="javascript:" class="user_menu" title="회원메뉴"><span class="material-icons">person</span></a>
			<ul>
				<?php if ($is_member) {  ?>
		...
		<div class="util pc_only">
		    <a href="<? Echo G5_URL ?>/gpcqua_eng/" class="eng" title="To English/영문사이트"><strong class="e_btn"><span class="material-icons">language</span>ENG</strong></a><!--title="ENGLISH"-->
        ...
        <div class="m_util_wrap">
            ...
            <a href="<?php echo G5_BBS_URL ?>/login.php" class="btn_user mobile_only" title="회원메뉴"><span class="material-icons">person</span></a> 
            <a href="javascript:" class="btn_search mobile_only" title="검색"><span class="material-icons">search</span></a>
            <a href="javascript:" class="btn_gnb mobile_only" title="모바일 메뉴 열기/닫기"><i class="fa fa-bars" aria-hidden="true"></i></a>
            <a href="<? Echo G5_URL ?>/gpc_eng/" class="btn_eng mobile_only" title="ENGLISH"><strong class="e_btn"><span class="material-icons">language</span>ENG</strong></a>
...
-->
    ...
    <div class="header_btm_border"></div> <!--header 하단, 메인 메뉴 하단에 border 생성 211222 전산팀 yr-->
...
$(function(){
	...
	if(!isMobile){
		...
		$("#header").on("mouseleave", function(){
         ...
         /* 유틸리티 회원메뉴 클릭시 header gnb.down 추가 20210608 책임자: HJ */
...
$str = explode("/",$_SERVER["REQUEST_URI"]); 
	switch($str[3]){ // url 3번째 폴더명 기준으로 navigation경로 수동 지정
		case "service" : $pageName="제공서비스"; $depth1="> 제공서비스"; $depth1_link="/theme/gpcert/service/auditor_scheme.php"; break;
	} 
?> 
