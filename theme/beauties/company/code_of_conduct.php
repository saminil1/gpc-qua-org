...
<div class="content_wrap">
	<section class="vision_type1 animatedParent">
        <div class="top_tt animated fadeInUpShort">GPC 자격 수여자 행동강령</div>
        <h2 class="animated fadeInUpShort top_txt">
            GPC 인증원은 GPC가 인증한 자격 수여자가 충족해야 하는 윤리적 요구사항에 대한 기준을 제시합니다. 이에 GPC 자격 수여자는 아래의 행동강령에 동의하여 GPC가 인증한 자격 수여자로서 요구되는 기준을 입증하게 됩니다.
        </h2>
              <br>
        <!-------행동강령 이미지------->
<!--		<div class="img_div animated fadeInUpShort"><img src="./images/code_of_conduct_img.jpg" alt="행동강령 이미지"></div>-->
            ...
            <div class="img_div animated fadeInUpShort">
             <img src="../img/company_03.png" alt="GPC인증원 건물 이미지" style="max-width: 70%; height: auto; margin: 0 auto; display: block; border: 1px solid pink;padding:10px;">
             </div>
		...
		<ul class="clear act_box animated fadeInUpShort">
            <li>
                ...
                <span class="act_txt">GPC 자격 수여자는 객관적이고 전문적으로 업무를 행한다.</span>
            </li>
            <li class="second_box">
                <span class="act_tt"><span>02</span></span>
                <span class="act_txt">GPC 자격 수여자는 스스로 전문적인 능력을 개발하고 높은 수준의 퀄리티를 위해 최상의 상태를 유지한다.</span>
            </li>
            <li class="right_box">
                <span class="act_tt"><span>03</span></span>
                <span class="act_txt">GPC 자격 수여자는 이해의 충돌을 일으킬 수 있는 어떠한 것에도 관여하지 않는다.</span>
            </li >
            <li class="second_box">
                <span class="act_tt"><span>04</span></span>
                <span class="act_txt">GPC 자격 수여자는 인증기관의 명성, 이해관계, 신뢰성을 해치는 행위를 하지 않는다.</span>
            </li>
            <li>
                <span class="act_tt"><span>05</span></span>
                <span class="act_txt">GPC 자격 수여자는 관련된 조직 또는 이해관계자로부터 금품, 선물 등 기타 이득을 취하지 않는다.</span>
            </li>
            <li class="right_box second_box">
                <span class="act_tt"><span>06</span></span>
                <span class="act_txt">GPC 자격 수여자는 GPC인증원의 인증프로세스의 완전성을 저해시킬 수 있는 허위 또는 위조된 정보를 전달하지 않는다.</span>
            </li>
            <li>
                <span class="act_tt"><span>07</span></span>
                <span class="act_txt">GPC 자격 수여자는 타 인원의 업무에 대해 무조건으로 비판하거나 이를 전달하지 않는다.</span>
            </li>
            <li class="second_box">
                <span class="act_tt"><span>08</span></span>
                <span class="act_txt">GPC 자격 수여자는 본 행동강령의 어떠한 부분도 위반하지 않으며 위반이 의심되는 경우 GPC에 의해 요청되는 모든 조사에 전적으로 협력한다.</span>
            </li>
<!--
            <li class="right_box">
                <span class="act_tt"><span>09</span></span>
                <span class="act_txt">GPC 심사원은 본 행동강령의 어떠한 부분도 위반하지 않으며 위반이 의심되는 경우 요청되는 모든 조사에 전적으로 협력한다.</span>
            </li>
-->
		</ul>
	</section>	
