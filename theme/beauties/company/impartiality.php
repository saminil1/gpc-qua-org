	...
	<section class="vision_type1 animatedParent">
        ...
        <!--공정성 선언문 이미지-->
            <div class="img_div animated fadeInUpShort">
               <img src="../img/company_02.png" alt="GPC인증원 건물 이미지" style="max-width: 70%; height: auto; margin: 0 auto; display: block; border: 1px solid pink;padding:10px;">
            </div>
             <br>
            ...
            <div class="mid_content01 clear"> <!--mid_content01-->
                <h2>공정의 약속</h2>
                 <div class="mid_content01_list">
                    ...
                    <p>- GPC의 모든 구성원들은 공정하게 업무를 수행하고 이해의 상충이 없도록 노력합니다.</p>
                    <p>- GPC의 모든 구성원들은 이해의 상충이 발생할 수 있는 업무에 대해 GPC에게 통지할 의무를 가집니다.</p>
