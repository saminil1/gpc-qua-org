...
/*회사안내- 이의제기 페이지 종료*/
    ...
    @media (max-width:1280px) {
        ...
        .lat .lt_more {position: absolute;top: 20px !important;right: 0 !important;}
    }
    ...
    @media only screen and (max-device-width : 768px) and (-webkit-min-device-pixel-ratio: 1) {
        ...
        .lat .lt_more {position: absolute;top: 15px !important;}
    }
...
<div class="content_wrap">
    ...
    <div class="appeal_box animatedParent">
        ...
        <h2 class="content_title animated fadeInUpShort">이의제기</h2>
            ...
            <!-- 이미지 삽입 -->
             <img src="../img/company_05.png" alt="GPC인증원 CI" style="max-width: 30%; height: auto; margin: 0 auto; display: block; border: 1px solid pink;padding:10px;">
             <br>
        ...
        <ul class="mid_content01 animated fadeInUpShort">
            <li>
                <div class="content_txt">
                    ...
                    행정부는 문서의 완전성을 확인해야 하며 필요한 경우 추가 문서를 요청할 수 있습니다. 행정부는 이의 제기 내용을 확인한 후 행정부장에게 전달해야 하며 행정부장은 이의 제기를 인정하지 않거나, 이의 제기 내용에 기반하여 어필패널을 구성할 권리가 있습니다.<br><br>

                   Adverse certification 또는 재인증에 대한 결정 또는 인증 취소에 대한 이의 제기는 서면으로 처리되어야 하며, 서면으로 작성된 이의 제기는 공식적으로 문서화된 절차를 통해 빠른 시일 내로 검토 및 해결되어야 합니다.<br><br>

                    <ul class="appeal_info2">
                        <li class="first_line">이의 제기는 다음과 같은 결정으로 진행될 수 있습니다.</li>
                    ...
                    어필패널은 신청인의 만족을 위하여 행정부장에게 필요한 조치를 하도록 권고사항을 제공합니다. <br><br>
                    ...
                    행정부장의 결정에 만족하기 어렵다면, 신청인은 GPC 인증원장에게 다시 이의를 제기할 수 있습니다. 인증원장은 3명으로 구성된 어필패널을 설립하고, 어필패널은 해당 상황을 조사하고 처리하기 위해 관련 절차를 따릅니다.<br><br>
    ...
    <div class="complaint_box animatedParent">
        ...
        <ul class="mid_content02 animated fadeInUpShort">
            <li>
                <div class="content_txt">
                    제기된 불만의 경우, 모두 행정부가 처리하게 됩니다. 행정부는 불만을 접수하고, 검증하고, 조사할 수 있는 모든 권한과 시정조치에 대한 결정권을 가집니다.<br>
                    
                    행정부장은 불만사항을 해결하기 위하여 필요한 시정 및 예방조치 등 GPC의 공식적인 처분을 지체없이 신청인에게 전달합니다.<br><br>

                    불만은 GPC 내 모든 직원에게 서면 또는 구두로 접수할 수 있습니다.<br>
                    
                    접수된 불만사항은 행정부장에게 전달되어 GPC의 고객불만 등록 리스트에 즉시 입력되며, 필요한 경우 불만 제기자에게 추가 정보를 요청할 수 있습니다.<br>
                    
                    불만사항은 전화 또는 메일을 통하여 접수된 후 24시간 이내에 확인되어야 하며, 전화, 메일 등을 통해 답변되어야 합니다. 가능하면 불만 처리 절차의 종료에 대하여 불만 제기자에게 공식적으로 통지되야 합니다.<br><br>
    ...
    <div class="appeal_complaint_box animatedParent">
        ...
        <div class="mid_content03 animated fadeInUpShort">
            <div class="content_txt">
                ...
                불만 및 이의 제기는 아래 방법을 통해 신청할 수 있습니다. <br>
            ...
            <ul class="appeal_info animated fadeInUpShort">
                ...
                <li><span class="material-icons">inbox</span><span class="appeal_info_tt">이메일</span><span class="info_detail gpc_email">qua@gpcert.org</span></li>
