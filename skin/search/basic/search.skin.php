...
<fieldset id="sch_res_detail">
    ...
    <label for="sfl" class="sound_only">검색조건1</label>
    <select name="sfl" id="sfl">
        <option value="wr_subject||wr_content"<?php echo get_selected($_GET['sfl'], "wr_subject||wr_content") ?>>제목+내용1</option>
...
<div id="sch_result">
    ...
    <section id="sch_res_ov">
        <h2><strong><?php echo $stx ?></strong> 전체검색 결과1</h2>
        <ul>
            <li>게시판1 <?php echo $board_count ?>개</li>
            <li>게시물1 <?php echo number_format($total_count) ?>개</li>
