...
@media all and (min-width:360px) and (max-device-width : 414px) {
        .main_cert .form_wrap {/* 모바일 해상도에 맞춰 검색 입력폼 & 검색 버튼 영역 width 100%로 변경 */
            width: 100%;
    }
	...
	<div class="flex_wrap animatedParent animateOnce" data-sequence="500">
		...
		<div class="text animated fadeInUpShort" data-id="2">
			<div class="animatedParent animateOnce" data-sequence="250">
				...
				<p class="animated fadeInUpShort" data-id="2">GPC는<br class="pc_only_2"> 고객의 전문 역량 제고에 기여하는 <br class="pc_only_2">공인된 개인 자격 인증 기관입니다.</p>
