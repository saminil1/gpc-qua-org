...
?>
	...
	<p>심사원등록 내용에 동의하셔야 심사원등록을 하실 수 있습니다.</p>
    <section id="fregister_term">
        <h2>심사원등록 약관</h2>
        <textarea readonly><?php echo get_text($csconfig['cf_stipulation']) ?></textarea>
        <fieldset class="fregister_agree">
            <label for="agree">심사원등록 약관의 내용에 동의합니다.</label>
            <input type="checkbox" name="agree" value="1" id="agree">
        </fieldset>
    </section>

    <div class="btn_confirm">
        <input type="submit" class="btn_submit" value="심사원등록">
    </div>
	...
	<script>
		function fregister_submit(f) {
			if (!f.agree.checked) {
				alert("약관에 동의하셔야 심사원등록을 하실 수 있습니다.");
				f.agree.focus();
				return false;
			}
